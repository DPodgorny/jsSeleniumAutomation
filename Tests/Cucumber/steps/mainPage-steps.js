...
Then(/^'(.+)' is visible$/, async function(element) {
    ...
    //await expect(mainPage.elementData[element].isPresent()).to.equal(true);
    //function fun(){mainPage.elementData[element].isPresent().then(function(a){return a;});};
    //var expected = mainPage.elementData[element];
